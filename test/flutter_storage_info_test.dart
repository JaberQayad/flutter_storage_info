...
void main() {
  ...
  test('getPlatformVersion', () async {
    ...
    MockFlutterStorageInfoPlatform fakePlatform = MockFlutterStorageInfoPlatform();
  ...
  test('getExternalStorageTotalSpaceInMB', () async {
    ...
    expect(await flutterStorageInfoPlugin.getExternalStorageTotalSpaceInMB(), 42.0);
  });
  ...
  test('getExternalStorageFreeSpaceInMB', () async {
    ...
    expect(await flutterStorageInfoPlugin.getExternalStorageFreeSpaceInMB(), 42.0);
  });
  ...
  test('getExternalStorageTotalSpaceInMB', () async {
    ...
    expect(await flutterStorageInfoPlugin.getExternalStorageTotalSpaceInGB(), 42.0);
  });
  ...
  test('getExternalStorageUsedSpaceInGB', () async {
    ...
    expect(await flutterStorageInfoPlugin.getExternalStorageUsedSpaceInGB(), 42.0);
  });
  ...
  test('getExternalStorageFreeSpaceInGB', () async {
    ...
    expect(await flutterStorageInfoPlugin.getExternalStorageFreeSpaceInGB(), 42.0);
  });
