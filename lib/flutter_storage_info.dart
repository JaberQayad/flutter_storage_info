...
class FlutterStorageInfo {
  ...
  Future<double?> getExternalStorageTotalSpaceInMB() {
   return FlutterStorageInfoPlatform.instance.getExternalStorageTotalSpaceInMB();
  }

  Future<double?> getExternalStorageFreeSpaceInMB() {
   return FlutterStorageInfoPlatform.instance.getExternalStorageFreeSpaceInMB();
  }

  Future<double?> getExternalStorageUsedSpaceInMB() {
   return FlutterStorageInfoPlatform.instance.getExternalStorageUsedSpaceInMB();
  }

  Future<double?> getExternalStorageTotalSpaceInGB() {
   return FlutterStorageInfoPlatform.instance.getExternalStorageTotalSpaceInGB();
  }

  Future<double?> getExternalStorageFreeSpaceInGB() {
   return FlutterStorageInfoPlatform.instance.getExternalStorageFreeSpaceInGB();
  }

  Future<double?> getExternalStorageUsedSpaceInGB() {
   return FlutterStorageInfoPlatform.instance.getExternalStorageUsedSpaceInGB();
  }
